	...
	return (
		<div
			...
			<ul className='flex flex-col gap-4'>
				<li className='ml-4 mb-2  text-lg  text-white'>Search Pens</li>
				<li className='ml-4 mb-2  text-lg  text-white'>Challenges</li>
				<li className='ml-4 mb-2  text-lg  text-white'>Spark</li>
			</ul>
		</div>
	);
};
